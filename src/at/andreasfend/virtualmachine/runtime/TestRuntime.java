...
public class TestRuntime {
	...
	private static List<Instruction> ggt() {
		...
		// While Head: 4
		ins.add(new Instruction(OperationType.NOTEQUALS, new Operand("zahl2", Type.ID), new Operand("0", Type.VAL), "cpw"));
		...
		ins.add(new Instruction(OperationType.JMP, new Operand(12, Type.VAL), null, null));
			// While Body
			// IF Statement: 7
			ins.add(new Instruction(OperationType.BIGGER, new Operand("zahl1", Type.ID), new Operand("zahl2", Type.ID), "cpi"));
			...
			ins.add(new Instruction(OperationType.JMP, new Operand(10, Type.VAL), null, null));
				...
				// THEN: 10
				ins.add(new Instruction(OperationType.SUB, new Operand("zahl1", Type.ID), new Operand("zahl2", Type.ID), "zahl1"));
		
				// ELSE: 11
				ins.add(new Instruction(OperationType.SUB, new Operand("zahl2", Type.ID), new Operand("zahl1", Type.ID), "zahl2"));
	...
	private static List<Instruction> blockTest() {
		...
		ins.add(new Instruction(OperationType.CMP, new Operand("cmp", Type.ID), new Operand(whileBody, Type.VAL), null));
